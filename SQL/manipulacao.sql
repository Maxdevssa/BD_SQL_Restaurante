...
(3, 'Peixe, camarão, leite de coco, azeite de dendê, arroz', 'Mar & Terra Distribuidora'),
(2, 'Picanha, alho, arroz, farofa, vinagrete', 'Carnes Boi Nobre'),
...
SELECT * FROM pedidos;
INSERT INTO pedidos (id_cliente, id_produto, quantidade, data_pedido, status) 
VALUES (1, 4, 2, '2024-07-01', 'Concluído');
INSERT INTO pedidos (id_cliente, id_produto, quantidade, data_pedido, status) VALUES 
(1, 4, 2, '2024-07-01', 'Concluído'),
(3, 4, 2, '2024-07-01', 'Concluído'),
(6, 7, 3, '2024-07-01', 'Concluído'),
(8, 7, 4, '2024-07-01', 'Concluído'),
(10, 8, 5, '2024-07-02', 'Pendente'),
(15, 8, 6, '2024-07-02', 'Concluído'),
(22, 4, 7, '2024-07-02', 'Concluído'),
(18, 4, 8, '2024-07-02', 'Concluído'),
(4, 7, 9, '2024-07-02', 'Concluído'),
(6, 7, 10, '2024-07-03', 'Concluído'),
(9, 8, 11, '2024-07-03', 'Concluído'),
(11, 8, 12, '2024-07-03', 'Concluído'),
(24, 4, 13, '2024-07-03', 'Concluído'),
(27, 4, 14, '2024-07-03', 'Concluído'),
(17, 7, 15, '2024-07-03', 'Concluído'),
(7, 7, 16, '2024-07-04', 'Concluído'),
(13, 8, 17, '2024-07-04', 'Concluído'),
(25, 8, 18, '2024-07-04', 'Concluído'),
(22, 4, 19, '2024-07-04', 'Concluído'),
(2, 4, 20, '2024-07-04', 'Concluído'),
(8, 7, 2, '2024-07-04', 'Concluído'),
(11, 7, 3, '2024-07-05', 'Concluído'),
(18, 8, 4, '2024-07-05', 'Concluído'),
(22, 8, 5, '2024-07-05', 'Concluído'),
(19, 4, 6, '2024-07-05', 'Concluído'),
(28, 4, 7, '2024-07-05', 'Concluído'),
(1, 7, 8, '2024-07-05', 'Concluído'),
(7, 7, 9, '2024-07-05', 'Concluído'),
(19, 8, 10, '2024-07-05', 'Concluído'),
(15, 8, 11, '2024-07-05', 'Concluído'),
(24, 4, 12, '2024-07-05', 'Concluído'),
(12, 4, 13, '2024-07-05', 'Concluído'),
(4, 7, 14, '2024-07-05', 'Concluído'),
(9, 7, 15, '2024-07-06', 'Concluído'),
(18, 8, 16, '2024-07-06', 'Concluído'),
(5, 8, 17, '2024-07-06', 'Pendente'),
(22, 4, 18, '2024-07-06', 'Concluído'),
(14, 4, 19, '2024-07-06', 'Pendente'),
(19, 7, 20, '2024-07-06', 'Concluído'),
(8, 7, 1, '2024-07-06', 'Pendente'),
(7, 8, 2, '2024-07-06', 'Concluído'),
(4, 8, 3, '2024-07-06', 'Pendente'),
(21, 4, 4, '2024-07-06', 'Concluído'),
(4, 4, 5, '2024-07-06', 'Pendente'),
(13, 7, 6, '2024-07-06', 'Concluído'),
(25, 7, 7, '2024-07-06', 'Pendente'),
(7, 8, 8, '2024-07-06', 'Concluído'),
(15, 8, 9, '2024-07-06', 'Pendente'),
(12, 4, 10, '2024-07-06', 'Concluído'),
(10, 4, 11, '2024-07-06', 'Pendente');

-- Verificar IDs na tabela funcionarios
SELECT id_funcionario, nome FROM funcionarios
ORDER BY id_funcionario;

-- Verificar IDs na tabela clientes
SELECT id_cliente, nome FROM clientes
ORDER BY id_cliente;

-- Verificar IDs na tabela produtos
SELECT id_produto, nome FROM produtos
ORDER BY id_produto;

-- Verificar IDs na tabela info_produtos
SELECT id_info, id_produto FROM info_produtos
ORDER BY id_info;

-- Verificar IDs na tabela pedidos
SELECT id_pedido, id_cliente, id_produto FROM pedidos
ORDER BY id_pedido;
